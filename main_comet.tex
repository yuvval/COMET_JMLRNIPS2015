...
\end{tabular}
\vskip -5pt
\parbox{12.5cm}{\RawCaption{\caption*{\footnotesize $T$ is the number of constraints (triplets), $d$ is the dimension, $0<\gamma \leq 1$ is the data sparsity, often is $O(1/\sqrt{d})$, and $P$ is the size of triplets batch between PSD projections for the SGD based methods; in \citep{qian} they used $T/P=0.1 T$.}}}
...
\end{subfigure}%
\setcounter{subfigure}{0} % reset subfigure counter for the next figure
}
\end{figure}
...
\hline
Reuters CV1 (5K features)&  573 $\pm$    22 & \parbox[t]{3.5cm}{\centering 238 $\pm$    8 ($\rho$ = 10.6\%)  \\ 121 $\pm$    TBD ($\rho$ = 0.5\%)} &522 $\pm$    24 &   423 $\pm$    29 & \\ 
...
\setcounter{subfigure}{0} % reset subfigure counter for the next figure  
\captionsetup{font=small}
\floatbox[{\capbeside\thisfloatsetup{capbesideposition={bottom, right},capbesidewidth=0.3\linewidth}}]{figure}
%[\FBwidth]
