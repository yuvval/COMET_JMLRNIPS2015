...
{\begin{subfigure}[]%{0.5\textwidth}
        \centering
        \includegraphics[trim=+1.6cm 0 0 0, width=4.5cm]{sparse_W_visualization}
\end{subfigure}
\begin{subfigure}[]%{0.5\textwidth}
        \centering
